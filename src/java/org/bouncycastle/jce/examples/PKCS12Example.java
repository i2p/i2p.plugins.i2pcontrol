...
public class PKCS12Example
{
        ...
        throws Exception
    {
        ...
        attrs.put(X509Name.OU, "Bouncy Intermediate Certificate");
        ...
        throws Exception
    {
        ...
        sAttrs.put(X509Name.C, "AU");
        sAttrs.put(X509Name.O, "The Legion of the Bouncy Castle");
        sAttrs.put(X509Name.OU, "Bouncy Intermediate Certificate");
        sAttrs.put(X509Name.EmailAddress, "feedback-crypto@bouncycastle.org");

        sOrder.addElement(X509Name.C);
        sOrder.addElement(X509Name.O);
        sOrder.addElement(X509Name.OU);
        sOrder.addElement(X509Name.EmailAddress);
        ...
        attrs.put(X509Name.CN, "Eric H. Echidna");
        attrs.put(X509Name.EmailAddress, "feedback-crypto@bouncycastle.org");
